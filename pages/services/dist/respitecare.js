            ...
            react_1["default"].createElement(grommet_1.Box, { background: { color: 'light-3', opacity: 0.0 }, gap: 'large', margin: 'none', align: "center", direction: 'row-responsive', alignSelf: 'center' },
                                    ...
                                    react_1["default"].createElement(grommet_1.Box, { pad: 'medium', margin: { horizontal: 'large', vertical: 'xlarge' }, gap: 'medium' },
                                        react_1["default"].createElement(grommet_1.Box, { gap: 'small' },
                                            react_1["default"].createElement(grommet_1.Box, null,
                                                react_1["default"].createElement(grommet_1.Heading, { level: "2", color: 'brand' }, "Our Respite Program."),
                                                react_1["default"].createElement(grommet_1.Paragraph, { color: 'black' }, "Knowing how important your health and peace of mind as the primary care giver for your loved one is to your effectiveness in taking care of your loved one, we go an extra mile to ensure that you get the break you need as we stand in for you. Our respite care program is designed in such a way that we select the perfect match not only to replace you but to also meet the special needs of your loved one so that they can always feel like you are around even when you break off to take your intervals of rest or relief.")),
                ...
                react_1["default"].createElement(grommet_1.Box, { background: 'transparent', width: 'large', height: 'large' },
                    react_1["default"].createElement(grommet_1.Box, { fill: true, align: 'center', justify: 'center' },
                        react_1["default"].createElement(grommet_1.Heading, { level: '1', color: 'light-1', size: 'large', textAlign: 'center' }, "You can trust us to stand in for you regardless."))))),
